...
export interface paths {
    ...
    "/destinations": {
        ...
        /** List administrator-configured export destinations */
    ...
    "/jobs/{jobId}/outputs/{position}": {
        ...
        /** Download one owned completed download output */
    ...
    "/settings": {
        ...
        /** Read administrator runtime settings and safe root diagnostics */
        get: operations["getSettings"];
        /** Replace administrator runtime settings */
    ...
    "/settings/media/refresh": {
        ...
        get?: never;
        put?: never;
        /** Refresh the media library as an administrator */
...
export interface components {
    schemas: {
        ...
        ProjectInput: {
            ...
            uiState: components["schemas"]["UIState"];
        };
        ...
        ExportInput: {
            ...
            /** @enum {string} */
            container: "mkv";
            /** @description Opaque administrator destination ID; never a filesystem path. */
...
export interface operations {
    ...
    getSettings: {
        ...
        requestBody?: never;
        responses: {
            /** @description Effective settings (including raw paths) for an authorized administrator */
            200: {
                headers: {
                    [name: string]: unknown;
                };
