...
| `terra-stage-0-test-1` | `gpt-5.6-terra` | 0 | baseline test specialist | `agent/terra-stage-0-baseline` | `.worktrees/terra-stage-0-baseline` | `docs/refactor/baseline-test-results.md` | all other paths | frozen Stage 0 contract; Go 1.26.5 | exact reproducible baseline | `make check`; `make test`; `make smoke`; Playwright | pending | planned |
