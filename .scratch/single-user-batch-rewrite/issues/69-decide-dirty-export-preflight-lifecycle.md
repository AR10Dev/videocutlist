...
- [x] Delayed save, preflight, cancellation, and export polling tests match the chosen contract.
- [x] `make check` and relevant Playwright tests pass.
...
- Validation: full Playwright (43 passed) and `make check` pass.
