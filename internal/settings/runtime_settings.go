...
func (c *Config) ApplyRuntimeSettings(settings store.RuntimeSettings) error {
	...
	c.MediaMaxFiles, c.MediaMaxDepth, c.MCPEnabled = settings.MediaMaxFiles, settings.MediaMaxDepth, settings.MCPEnabled
	return nil
}
