// Package jobs shares preview processes between foreground subscribers.
package jobs
...
func NewPreviewManager(store *cache.Store, runner contracts.PreviewRunner, validator cache.Validator, limiter *limits.Preview) (*PreviewManager, error) {
...
func (m *PreviewManager) Preview(ctx context.Context, user string, spec contracts.PreviewSpec) (io.ReadCloser, Result, error) {
	if user == "" {
...
type previewJob struct {
	...
	running *contracts.RunningPreview
