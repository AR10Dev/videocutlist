...
type PreviewRunner interface {
	Start(context.Context, model.PreviewSpec) (*RunningPreview, error)
}
...
func (m *PreviewManager) Preview(ctx context.Context, spec model.PreviewSpec) (io.ReadCloser, Result, error) {
